...
const CheckInWorkflow = DefineWorkflow({
  ...
  description: "Choose where you are working today and update the team summary.",
  input_parameters: {
    properties: {
    ...
    elements: [
      {
        ...
        choices: [
          { value: "ATL55", title: "🏢 ATL55" },
          { value: "ATL66", title: "🏢 ATL66" },
          { value: "ATL77", title: "🏢 ATL77" },
          { value: "ATL88", title: "🏢 ATL88" },
          { value: "ATL99", title: "🏢 ATL99" },
          { value: "ATL118", title: "🏢 ATL118" },
          { value: "REMOTE", title: "🏠 Remote" },
          { value: "OFF", title: "🏖️ Off" },
        ],
      },
    ],
    required: ["site"],
